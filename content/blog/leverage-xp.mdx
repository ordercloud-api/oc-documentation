...
date: 2016-09-03
featuredImage: /images/blog/thumbnails/extended_properties.jpg
summary: We can't predict every column in every table that your hypothetical database might need. That's why we created our own schema-less solution with Extended Properties (XP) and exposed it on every API resource.
---
