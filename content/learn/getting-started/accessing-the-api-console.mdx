...
Click "SELECT A CONTEXT". This will present a list of your available seller organizations. Choose the organization that we created in the last article. At this point, the context selector should close and you will automatically be authenticated using the **FullAccess** API Role provided to you as the owner.
