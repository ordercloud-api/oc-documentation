...
Click on the "Select a Context" button. This will present a list of your available seller organizations. Choose the example organization that we created in the last article. At this point, the context selector should close and you will automatically be authenticated using your Owner's **FullAccess** API Role.
...
This is what we call a "Default User" - it is essentially an Admin User that will have the same level of data access as your Portal User. Don't be alarmed if the Available Roles field is empty - as the owner of the organization it is implied that you have Full Access.
