...
Creating a Portal account is free, and provides access to all OrderCloud features through a [sandbox environment](/blog/introducing-ordercloud-environments). You can create an account manually using an email address or alternatively sign-in using GitHub or Google. You can always link these accounts later in your Portal authentication settings if you do not wish to use GitHub or Google right away.
...
_consider moving the content below into a blog post_
