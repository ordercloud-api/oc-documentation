...
The base url will get changed based on the region selected during the market place creation. Please check the base url by navigating to the market place in the api console near the top left and replace it in the following snippets.
