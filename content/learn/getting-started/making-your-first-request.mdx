...
The base url will get changed based on the region and environment selected when your marketplace was first created. Please check the base url by navigating to the market place in the api console near the top left and replace it in the following snippets.


![image](https://user-images.githubusercontent.com/24582619/161112813-f2e1f842-df7e-4f20-abd6-03e6dca60ad6.png)
