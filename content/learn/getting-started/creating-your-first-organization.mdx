...
<ContentLink subtitle="Further Reading" to="/blog/introducing-portal-environments">Portal Environments</ContentLink>
...
After you successfully create your first seller organiaztion, you will be brought to the its **settings view**. Notice the organization environment is set to sandbox and the API server you will use to interact with it.
...
<ContentLink subtitle="Further Reading" to="/blog/access-control-using-portal-teams">Access Control Using Portal Teams</ContentLink>
