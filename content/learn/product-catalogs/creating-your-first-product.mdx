...
try {
    Product response = await client.Products.CreateAsync(product);
...
If the shirt came in multiple sizes or colors, you would likely create a new spec and assign it to the product. _Once again, to keep this simple product specs and variants will be covered in future guides._
