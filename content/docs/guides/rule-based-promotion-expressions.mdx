...
**Roadmap**
 ...
 - `v1/orders/{direction}/{orderID}/validate` endpoint that will check validity of an order in it's current state, including, but not limited to, applied promotions (<Link to="/api-reference/orders-and-fulfillment/orders/validate">released in v1.0.131</Link>)
