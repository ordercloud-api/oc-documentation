...
(*) Additionally, you can set up your hook to inherit the routing URI (Append Route) and/or HTTP method (Use HTTP Method From Route) from the OrderCloud endpoint which triggered it. By default the Base URL will be called with POST.
