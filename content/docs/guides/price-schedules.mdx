...
<CodeExample
  content={{
    http: `POST https://api.OrderCloud/v1/priceschedules
...
var response = await PriceSchedules.Create({
  "ID": "enterprise-priceschedule-id"
  "Name": "USB Cord",
  "MinQuantity": 1,
  "PriceBreaks": [
...
typescript: `import { PriceSchedule, PriceSchedules } from "ordercloud-javascript-sdk";\n
const data:Partial<PriceSchedule> = {
  "ID": "enterprise-priceschedule-id"
  "Name": "USB Cord",
  "MinQuantity": 1,
  "PriceBreaks": [
...
var response:PriceSchedule = await PriceSchedules.Create(data)`
}}
/>
