...
Buyer product visibility is powered completely via assignments. Recall that assignments are inclusive meaning that, to start with, a user will have no assignments made to them and thus will not see any products.
...

{
	...
	"BuyerID": "MyBuyerID",
	"ViewAllCategories": true/false,
	"ViewAllProducts": true/false
},
```
...
Having trouble getting visibility to work? Here's a quick checklist to help you get to the bottom of it.
