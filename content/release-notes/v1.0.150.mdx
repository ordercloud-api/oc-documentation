...
- **New endpoint:** GET `v1/orders/{direction}/{orderID}/shipments`. Use to list shipments for a given order. Prefer over GET `v1/shipments?orderID={orderID}`, especially from a Seller perspective, due to explicit support for incoming and outgoing orders.
