...
Notably, you can assign _all_ [buyers](https://developer.ordercloud.io/documentation/api-reference/Buyers) in a Company Organization to an API Client ID, or only specific ones.
