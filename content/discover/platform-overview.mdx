...
priority: 0
description: 'OrderCloud is a B2B-first commerce and marketplace development platform, OrderCloud delivers cloud-based, API-first, headless eCommerce architecture. Limitless customizations and endless freedom for growth to support your complete commerce strategy.'
---
...
![Infrastructure Architecture](/images/discover/792_oc_platform_overview-1.png)
...
![Modeling Your Business on OrderCloud vs. B2C-Only Platforms](/images/discover/792_oc_platform_overview-2.png)
...
<ContentLink to="/learn/getting-started/intro-to-ordercloud" subtitle="Developer Guide" type="education">Getting Started</ContentLink>
...
<ContentLink to="/discover/define-your-marketplace" subtitle="Further Reading">Personalized Shopping</ContentLink>
...
<ContentLink to="/discover/define-your-marketplace" subtitle="Further Reading">Fulfillment Automation</ContentLink>
...
![OrderCloud Omni-Channel Integration with API Clients](/images/discover/792_oc_platform_overview-3.png)
...
![OrderCloud Experience API 'Me' Endpoints](/images/discover/792_oc_platform_overview-4.png)
...
![OrderCloud Integration for External Business Logic](/images/discover/792_oc_platform_overview-5.png)
