...
priority: 2
description: 'Discover how you can setup personalized product catalogs, pricing, and promotions to support your eCommerce marketplace strategy'
---
...
![Catalog Visibility Rules](/images/discover/792_oc_personalized_shopping.png)

<ContentLink to="/knowledge-base/catalog-visibility-rules" subtitle="Developer Guide" type="education">Catalog Visibility Rules</ContentLink>
...
<ContentLink to="/api-reference/me-and-my-stuff/my-products/list-products" subtitle="API Reference" type="bookmark">Me and My Stuff: Product List</ContentLink>
...
![Example Category Taxonomies](/images/discover/792_oc_personalized_shopping2.png)
...
<ContentLink to="/knowledge-base/new-for-premium-search" subtitle="Developer Guide">Enhanced Product Search</ContentLink>
...
<ContentLink to="/api-reference/me-and-my-stuff/my-products" subtitle="API Reference" type="bookmark">Me and My Stuff: My Products</ContentLink>
...
To read through specific implementation scenarios with our API, check out [how to assign multiple price schedules](/knowledge-base/same-product-multiple-price-schedules).  As with the flexibility of OrderCloud to compose and extend, if the use of pre-loaded price schedules doesn’t work for you, you can leverage your own middleware or integrations to offer and assign pricing.
...
<ContentLink to="/api-reference/product-catalogs/price-schedules/save-price-break" subtitle="API Reference" type="bookmark">OrderCloud Price Breaks</ContentLink>
...
<ContentLink to="/knowledge-base/rule-based-promotion-expressions" subtitle="Developer Guide" type="education">Rules-Based Promotion Expressions</ContentLink>
