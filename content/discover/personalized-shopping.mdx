...
<ContentLink to="/api-reference/categories" subtitle="API Reference" type="bookmark">OrderCloud Categories</ContentLink>
...
<ContentLink to="/api-reference/products" subtitle="API Reference" type="bookmark">OrderCloud Products</ContentLink>
...
<ContentLink to="/api-reference/products" subtitle="Developer Guide" type="education">Creating Facets Using Product XP</ContentLink>
