...
priority: 1
description: 'Choosing a marketplace platform is ideal for organizations who know the complexity of doing business should be modernized and managed and delivered through multiple frontends, no matter the persona of the buyer, seller, or supplier.'
---
...
- Optionally extend into B2C on the same organization setup
...
Flexibility is a clear advantage with OrderCloud, and there’s nothing to stop you from starting with one market strategy and pivoting to another within the same ‘instance’ of OrderCloud for your organization.  Let's walk through the example of a B2B company opening up to other resellers or direct to consumers.
...
<CodeExample
  ...
  content={{
    http: `GET https://api.ordercloud.io/buyers?filters=xp.MySalesRegion=USNW HTTP/1.1
