...
<ContentLink to="/ordercloud-basics/building-blocks" subtitle="Developer Reading">OrderCloud Basics: Building Blocks</ContentLink>
...
<ContentLink to="/blog/leverage-xp" subtitle="Developer Guide" type="developer">Leveraging XP</ContentLink>
