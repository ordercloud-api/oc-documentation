...
The integration "just works" when the linked storefront code and seed template are used. However, it can be used to connect a custom storefront with a matching custom ordercloud configuration. 