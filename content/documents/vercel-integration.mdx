...
3. Create a new vercel project and connect it to the forked repository. Then go to Integrations -> Browse Marketplace -> OrderCloud, or [this link](https://vercel.com/integrations/order-cloud), and click "Add Integration".
