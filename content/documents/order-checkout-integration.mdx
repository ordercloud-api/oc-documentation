...
```json
{
	...
	"Environment": "Sandbox",
	"OrderCloudAccessToken": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImlnX2RRdEpXVmtXdkdTdHJ5RDVEclEifQ...",
	"OrderWorksheet": {
		"LineItems": [],
		"Order": {},
...
Sample response body from your application (i.e. the response from your hosted Integration Event code):
