...
tags:           ["Authentication", "API Clients", "Security Profiles", "OpenID Connects", "Tutorial"]
---
...
When security really matters. This is the same as the [password grant type workflow](/knowledge-base/authentication#password-grant-type-workflow) except with an additional requirement of client secret.
