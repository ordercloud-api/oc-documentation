...
Production is reserved for live apps with real buyers and sellers performing real transactions, and nothing else. It's provisioned for high performance, high availability, and geo-redundant data protection. In order to keep this premium environment performing at the highest possible level, we do a bit more "gatekeeping" of what goes in, this means it isn't possible for you to create a production instances yourself. We recommend contacting us at least a month before you plan on going live so that we can work out pricing and get you set up with a production instance.
