...
After correcting xp schema inconsistencies for your affected resource, check your active index for any lingering errors. If you still see error logs, you will need to "reset" your xp schema in Elasticsearch. This can be accomplished by triggering a full index rebuild to generate a brand-new index from the master OrderCloud record. A few things to note for the rebuild action:
