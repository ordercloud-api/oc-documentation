---
type:           article
title:          The Rules Engine Has Arrived
description:    Extend platform behavior using a system of rules similar to XP allowing you to extend the data model.
author:         tmenier
publishDate:    2016-06-13
updatedDate:    2020-07-28
tags:           ["Best Practices", "Rules Engine", "Approval Rules", "Promotions"]
---
...
<!-- TODO: fix this link once create your first webhook is re-made- Fire off a notification via [Webhooks](https://documentation.ordercloud.io/integration-services/overview/your-first-webhook)-->

In short, order approvals are just the beginning. We envision this new rules engine playing a key role in our <Link to="/knowledge-base/flexibility-over-features">"Flexibility over Features"</Link> platform strategy. Stay tuned!
