...
This feature is now enabled in all non-production marketplaces. Any production marketplace created after April 20, 2022 also has premium search for orders enabled. If your production marketplace was created prior to that date and you would like the feature enabled please reach out to your OrderCloud support contact.
