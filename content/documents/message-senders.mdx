...
Notify the buyer user when an admin user <Link to="/api-reference/buyers/users/create">creates them</Link> or when they <Link to="/api-reference/me-and-my-stuff/me/register">self register</Link></td>
    ...
    <tr>
      <td>OrderApproved</td>
      <td>Notify the buyer user when the order that was previously on hold, <Link to="/api-reference/orders-and-fulfillment/orders/approve">has been approved</Link> and released for fulfillment</td>
    </tr>
    <tr>
      <td>OrderDeclined</td>
    ...
    <tr>
      <td>OrderReturnSubmitted</td>
      <td>Notify the buyer user when they <Link to="/api-reference/orders-and-fulfillment/order-returns/submit">submit an order return</Link></td>
    </tr>
    <tr>
      <td>OrderReturnSubmittedForApproval</td>
      <td>Notify the buyer user when their order has <Link to="/api-reference/orders-and-fulfillment/order-returns/submit">been submitted</Link>, but has been placed on hold pending approval</td>
    </tr>
    <tr>
      <td>OrderReturnApproved</td>
      <td>Notify the buyer user when the order that was previously on hold, <Link to="/api-reference/orders-and-fulfillment/order-returns/approve">has been approved</Link> and released for fulfillment</td>
    </tr>
    <tr>
      <td>OrderReturnDeclined</td>
      <td>Notify the buyer user when the order return that was previously on hold, <Link to="/api-reference/orders-and-fulfillment/order-returns/decline">has been declined</Link> and will not be fulfilled</td>
    </tr>
    <tr>
      <td>OrderReturnSubmittedForYourApproval</td>
      <td>Notify approving users that there is a new order return pending their approval</td>
    </tr>
    <tr>
      <td>OrderReturnSubmittedForYourApprovalHasBeenApproved</td>
      <td>Notify approving users that an order return that was previously on hold pending their approval <Link to="/api-reference/orders-and-fulfillment/order-returns/approve">has been approved</Link></td>
    </tr>
    <tr>
      <td>OrderReturnSubmittedForYourApprovalHasBeenDeclined</td>
      <td>Notify approving users that an order return that was previously on hold pending their approval <Link to="/api-reference/orders-and-fulfillment/order-returns/decline">has been declined</Link></td>
    </tr>
    <tr>
      <td>OrderReturnCompleted</td>
      <td>Notify buyer users that an order return they submitted <Link to="/api-reference/orders-and-fulfillment/order-returns/complete">is now complete</Link></td>
    </tr>
  </tbody>
</table>
...
5. Select which message types you want to enable. For each message type provide your Mandrill Template Name. Check out our [default templates](https://github.com/ordercloud-api/mailchimp-email-templates/tree/master/Transactional) to use as a starting point.
...
- Check out our [default templates](https://github.com/ordercloud-api/mailchimp-email-templates/tree/master/Transactional) to use as a starting point.
      ...
      <td>
        <table>
          ...
          <tbody>
            <tr>
              <td>cost</td>
              <td>Products[i].LineItem.LineTotal</td>
            </tr>
            <tr>
              <td>quantity</td>
              <td>Products[i].LineItem.Quantity</td>
            </tr>
            <tr>
              <td>productdesc</td>
            ...
            <tr>
              <td>shiptoname</td>
              <td>Products[i].LineItem.ShippingAddress.FirstName + Products[i].LineItem.ShippingAddress.LastName</td>
            </tr>
            <tr>
              <td>shiptostreet1</td>
              <td>Products[i].LineItem.ShippingAddress.Street1</td>
            </tr>
            <tr>
              <td>shiptostreet2</td>
              <td>Products[i].LineItem.ShippingAddress.Street2</td>
            </tr>
            <tr>
              <td>shiptocity</td>
              <td>Products[i].LineItem.ShippingAddress.City</td>
            </tr>
            <tr>
              <td>shiptostate</td>
              <td>Products[i].LineItem.ShippingAddress.State</td>
            </tr>
            <tr>
              <td>shiptopostalcode</td>
              <td>Products[i].LineItem.ShippingAddress.Zip</td>
            </tr>
            <tr>
              <td>shiptocountry</td>
              <td>Products[i].LineItem.ShippingAddress.Country</td>
            </tr>
          </tbody>
        </table>
      </td>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>OrderApproval[i].ApprovingGroupID</td>
            </tr>
            <tr>
              <td>status</td>
              <td>OrderApproval[i].Status</td>
            </tr>
            <tr>
              <td>datecreated</td>
              <td>OrderApproval[i].DateCreated</td>
            </tr>
            <tr>
              <td>datecompleted</td>
              <td>OrderApproval[i].DateCompleted</td>
            </tr>
            <tr>
              <td>approverid</td>
              <td>OrderApproval[i].Approver.ID</td>
            </tr>
            <tr>
              <td>approveremail</td>
              <td>OrderApproval[i].Approver.Email</td>
            </tr>
            <tr>
              <td>approverfirstname</td>
              <td>OrderApproval[i].Approver.FirstName</td>
            </tr>
            <tr>
              <td>approverlastname</td>
              <td>OrderApproval[i].Approver.LastName</td>
            </tr>
            <tr>
              <td>approverusername</td>
              <td>OrderApproval[i].Approver.Username</td>
            </tr>
            <tr>
              <td>approverphone</td>
              <td>OrderApproval[i].Approver.Phone</td>
            </tr>
          </tbody>
        </table>
      </td>
      ...
      <td>
        <table>
          ...
          <tbody>
            <tr>
              <td>LineItemID</td>
              <td>OrderReturn.ItemsToReturn[i].LineItemID</td>
            </tr>
            <tr>
              <td>Quantity</td>
              <td>OrderReturn.ItemsToReturn[i].Quantity</td>
            </tr>
            <tr>
              <td>RefundAmount</td>
              <td>OrderReturn.ItemsToReturn[i].RefundAmount</td>
            </tr>
          </tbody>
        </table>
      </td>
    ...
    <tr>
      ...
      <td>
        <table>
          ...
          <tbody>
            <tr>
              <td>orderreturnxp_keyname</td>
              <td>for first-level xp properties</td>
            </tr>
            <tr>
              <td>orderreturnxp_keyname_keyname</td>
              <td>for nested xp properties</td>
            </tr>
            <tr>
              <td>orderreturnxp_keyname_index</td>
              <td>for xp arrays</td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Shipment.Items[i].QuantityShipped</td>
            </tr>
            <tr>
              <td>productdesc</td>
              <td>Shipment.Items[i].Product.Description</td>
            </tr>
            <tr>
              <td>productid</td>
              <td>Shipment.Items[i].Product.ID</td>
            </tr>
            <tr>
              <td>productname</td>
              <td>Shipment.Items[i].Product.Name</td>
            </tr>
          </tbody>
        </table>
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>OrderReturn</td>
      <td>The<Link to="/api-reference/orders-and-fulfillment/order-returns/get#response-body">order return</Link> that was submitted</td>
    </tr>
  </tbody>
</table>
