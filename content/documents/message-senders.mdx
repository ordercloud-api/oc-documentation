      ...
      <td>
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>productdesc</td>
              <td>LineItems[i].Product.Description</td>
            </tr>
            <tr>
              <td>productid</td>
              <td>LineItems[i].Product.ID</td>
            </tr>
            <tr>
              <td>productname</td>
              <td>LineItems[i].Product.Name</td>
            </tr>
            <tr>
              <td>shiptoname</td>
              <td>LineItems[i].ShippingAddress.FirstName + LineItems[i].ShippingAddress.LastName</td>
            </tr>
            <tr>
              <td>shiptostreet1</td>
              <td>LineItems[i].ShippingAddress.Street1</td>
            </tr>
            <tr>
              <td>shiptostreet2</td>
              <td>LineItems[i].ShippingAddress.Street2</td>
            </tr>
            <tr>
              <td>shiptocity</td>
              <td>LineItems[i].ShippingAddress.City</td>
            </tr>
            <tr>
              <td>shiptostate</td>
              <td>LineItems[i].ShippingAddress.State</td>
            </tr>
            <tr>
              <td>shiptopostalcode</td>
              <td>LineItems[i].ShippingAddress.Zip</td>
            </tr>
            <tr>
              <td>shiptocountry</td>
              <td>LineItems[i].ShippingAddress.Country</td>
            </tr>
          </tbody>
        </table>
      </td>
