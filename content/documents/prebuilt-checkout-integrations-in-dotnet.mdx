...
- Download a Publish Profile for your web app from Azure and save it as a Github repository secret. [Follow these steps](https://docs.microsoft.com/en-us/azure/app-service/app-service-sql-asp-github-actions#create-a-publish-profile-secret). This will authenticate deployments. 
- Run the github action by pushing to dev or manually. Once it succeeds, visit your base URL, you should see a UI with route documentation for the API.  
