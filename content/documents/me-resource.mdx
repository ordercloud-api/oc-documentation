...
description:    OrderCloud provides the Me Resource whose job it is to flatten these assignments for the currently authenticated user and just "show me what I can see" regardless at which level these assignments are made.
author:         rwatt
publishDate:    2015-02-24
updatedDate:    
tags:           ["Me", "Personalization", "Authentication"]
---
