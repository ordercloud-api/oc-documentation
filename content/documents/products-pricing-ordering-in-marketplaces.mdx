...
*We're planning to release these features to Sandbox in the next few days and to production by the end of June 2021.*
...
#### New endpoint for buyer users to read which Suppliers they have the ability to write to Order.ToCompanyID:
- `GET v1/me/sellers`

#### Buyer users can get pricing for a given Supplier by using the optional sellerID parameter on these endpoints:
