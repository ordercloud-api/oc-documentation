...
New OrderCloud resource to enable subscription ordering for buyer users on a set interval and frequency for a predetermined or indefinite amount of time.
This feature depends on the implementation of the Subscription Integration in order to submit orders. 

## Use Cases
- I have consumable goods that my customers order on an as needed basis or on a set schedule
