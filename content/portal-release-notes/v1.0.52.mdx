...
The OrderCloud Portal now provides the ability to create teams. A Portal Team is a group of users that share a common relationship with one or more Seller Organizations. Read more about [Portal Teams here](/knowledge-base/access-control-using-portal-teams)
...
### New Features
- Portal Teams ([Read More](/knowledge-base/access-control-using-portal-teams))
